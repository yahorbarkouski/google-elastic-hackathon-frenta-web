  ...
  return (
    ...
    >
      <div className="w-full max-w-3xl">
        ...
        <motion.div
          className="relative overflow-hidden rounded-[28px] border border-border bg-card/80 backdrop-blur-md shadow-[0_12px_40px_rgba(0,0,0,0.08)]"
          animate={{ x: 0 }}
        ...
        >
          ...
          <div className="flex items-center gap-3 px-4 py-2.5">
            ...
            <input
              ...
              placeholder={placeholder || "Search for best coffee shops nearby"}
              disabled={Boolean(disabled || loading)}
              className="flex-1 bg-transparent text-sm outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed"
            />
            <button
              type="button"
              className="ml-1 flex h-10 w-10 items-center justify-center rounded-full bg-secondary text-foreground/70 border border-gray-200 transition-colors hover:bg-accent"
